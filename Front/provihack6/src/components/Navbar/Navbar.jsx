...
export default function Navbar ({isHome, isMap, isShop}) {
    ...
    return (
        <MainStyle>
        <ImgStyled src={isHome ? HomeFilled : HomeIcon} alt="Ícone da Home" onClick={() => goToDashboard(navigate)}/>
        <ImgStyled src={isMap ? PinFilled : PinIcon} alt="Ícone do Mapa" onClick={() => goToLocation(navigate)}/>
        <ImgStyled src={isShop ? ShopFilled : ShopIcon} alt="Ícone da Loja" onClick={() => goToShop(navigate)}/>
        </MainStyle>
    )
}
